...
export const FooterGuaracheo = () => {
  ...
  return (
    <footer className="my-6 sm:my-8 px-3 sm:px-4 max-w-5xl mx-auto">
      <div className="relative bg-[#0f2618] rounded-2xl sm:rounded-3xl max-w-5xl mx-auto px-3 sm:px-4 py-8 sm:py-10 flex flex-col md:flex-row justify-between items-center gap-6 border border-[#b4ff00]/10">
        <div className="flex flex-col md:flex-row items-start justify-between gap-6 md:gap-10 px-2 sm:px-4 md:px-8 flex-1 w-full">
          <div className="flex flex-col items-start gap-2">
            <span className="text-xl sm:text-2xl font-extrabold text-[#b4ff00] tracking-wider">
              GUARACHEOO
            </span>
            <p className="text-white/40 font-medium text-sm sm:text-base w-full md:w-4/5">
      ...
      <div className="my-3 px-3 sm:px-4 md:px-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 text-xs sm:text-sm text-white/40">
